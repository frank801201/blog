...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
		...
		<div class="container text-center">
			...
			<nav id="fh5co-main-nav" role="navigation">
				<ul>
					...
					<li><a href="artacle.php">Article</a></li>
	...
	<div class="fh5co-parallax" style="background-image: url(images/contact-1.jpg);" data-stellar-background-ratio="0.5">
	...
	<div id="fh5co-contact-section">
		<div class="container">
			<div class="row">
				...
				<?php
                require_once("admin/db_class.php");
                $db = new DB();
				...
				<div class="col-md-8 animate-box">
					<div class="row">
						...
						<div class="col-md-12">
							<div class="form-group">
								<textarea name="title" class="form-control" id="" cols="1" rows="1" placeholder="title"></textarea>
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
						...
						<div class="col-md-12">
							<div class="form-group">
								<input type="submit" value="Send Message" class="btn btn-primary" onclick="form1.action='admin/mInsertBack.php';form1.submit();">
							</div>
						</div>
					</div>
				</div>
