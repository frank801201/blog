...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<div class="fh5co-parallax" style="background-image: url(images/about-1.jpg);" data-stellar-background-ratio="0.5">
	...
	<div id="fh5co-common-section">
		<div class="container">
			...
			<div class="row about">
				<div class="col-md-10 col-md-offset-1">
					<img class="img-responsive" src="images/about-2.jpg" alt="About">
				</div>
				<div class="col-md-10 col-md-offset-1">
